...
public class SymmetricDecryptor {
    ...
    public SymmetricDecryptor(final Key key, final String transformation,
    ...
    public SymmetricDecryptor(final Key key, final String transformation, final String keySpecAlg, final IvParameterSpec iv)
            throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException {
        this.sk = key;
        this.method = transformation;
        this.ciph = Cipher.getInstance(method);
        this.ciph.init(Cipher.DECRYPT_MODE, new SecretKeySpec(key.getEncoded(), keySpecAlg), iv);
    }
    public SymmetricDecryptor(final Key key, final String transformation,
